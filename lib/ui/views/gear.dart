      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              buildExpanded(context, texts.gearReview, Icon(Icons.backpack_outlined, size: 100.0)),
              buildExpanded(
                  context, texts.packLists, Icon(Icons.account_tree_outlined, size: 100.0)),
              buildExpanded(context, texts.hacks, Icon(Icons.architecture_outlined, size: 100.0)),
            ],
          ),
        ),
      ),

...
import 'packlist_controllers.dart';
...
class _StepperWidgetState extends State<StepperWidget> {
  ...
  PacklistControllers eventControllers;
  Event event;
  ...
  setControllers() {
    eventControllers = PacklistControllers(context);
  }
  ...
  Step getStep1() {
    ...
    return Step(
      title: new Text('Details'), // TODO : use localization
      content: Form(
          key: FormKeys.step1Key,
          child: Column(
            children: [
              TextInputFormFieldComponent(
                PacklistControllers.titleController,
      ...
      content: Column(children: [
        ...
        Form(
            ...
            child: Column(
              children: <Widget>[
                TextInputFormFieldComponent(
                  PacklistControllers.meetingPointController,
                  AuthenticationValidation.validateNotNull,
                  'Meeting point',
                  iconData: Icons.add_location_outlined,
                ),
                TextInputFormFieldComponent(
                  PacklistControllers.dissolutionPointController,
                  AuthenticationValidation.validateNotNull,
                  'Dissolution point',
          ...
          child: Column(
            children: <Widget>[
              Row(
                children: [
                  TextInputFormFieldComponent(
                    PacklistControllers.minParController,
                    AuthenticationValidation.validateNotNull,
                  ...
                  TextInputFormFieldComponent(
                    PacklistControllers.maxParController,
                    AuthenticationValidation.validateNotNull,
              ...
              TextInputFormFieldComponent(
                PacklistControllers.requirementsController,
                AuthenticationValidation.validateNotNull,
                'Participation requirements',
                iconData: Icons.tab,
              ),
              TextInputFormFieldComponent(
                PacklistControllers.equipmentController,
                AuthenticationValidation.validateNotNull,
                texts.equipment,
    ...
    return Step(
      ...
      content: Form(
          ...
          child: Column(
            children: <Widget>[
              TextInputFormFieldComponent(
                PacklistControllers.priceController,
                AuthenticationValidation.validateNotNull,
                texts.price,
                iconData: Icons.money_outlined,
              ),
              TextInputFormFieldComponent(
                PacklistControllers.paymentController,
                AuthenticationValidation.validateNotNull,
      ...
      content: Form(
          ...
          child: Column(
            children: <Widget>[
              ...
              TextInputFormFieldComponent(
                PacklistControllers.descriptionController,
                AuthenticationValidation.validateNotNull,
                texts.description,
      ...
      children: [
        GestureDetector(
            ...
            child: AbsorbPointer(
              ...
              PacklistControllers.startDateController,
        ...
        GestureDetector(
          ...
          child: AbsorbPointer(
              child: TextInputFormFieldComponent(
            PacklistControllers.startTimeController,
            AuthenticationValidation.validateNotNull, //AuthenticationValidation.validateDates,
            texts.startTime,
    ...
    return Row(
      ...
      children: [
        GestureDetector(
            ...
            child: AbsorbPointer(
                child: TextInputFormFieldComponent(
              PacklistControllers.endDateController,
              AuthenticationValidation.validateDates,
              texts.endDate,
              iconData: Icons.date_range_outlined,
              optionalController: PacklistControllers.startDateController,
              width: MediaQuery.of(context).size.width / 2.5,
        ...
        GestureDetector(
            ...
            child: AbsorbPointer(
                child: TextInputFormFieldComponent(
              PacklistControllers.endTimeController,
              AuthenticationValidation.validateNotNull,
              texts.endTime,
              iconData: Icons.access_time_outlined,
              width: MediaQuery.of(context).size.width / 3,
  ...
  Widget buildDeadlineField(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AbsorbPointer(
          child: TextInputFormFieldComponent(
        PacklistControllers.deadlineController,
        AuthenticationValidation.validateNotNull,
        texts.deadline,
        iconData: Icons.date_range_outlined,
      )),
      ...
      setState(() {
        ...
        switch (dateType) {
          case 'start':
            ...
            PacklistControllers.startDateController.text = formattedDate;
            break;
          case 'end':
            endDate = updateDateTime(picked, endTime);
            print('end date ' + endDate.toString());
            PacklistControllers.endDateController.text = formattedDate;
            break;
          case 'deadline':
            deadline = picked;
            print('from date ' + deadline.toString());
            PacklistControllers.deadlineController.text = formattedDate;
            break;
        }
      });
  }
      ...
      setState(() {
        ...
        switch (timeType) {
          case 'start':
            ...
            print('from date ' + startDate.toString());
            PacklistControllers.startTimeController.text = formattedDate;
            break;
          case 'end':
            endTime = picked;
            endDate = updateDateTime(endDate, picked);
            print('end date ' + endDate.toString());
            PacklistControllers.endTimeController.text = formattedDate;
            break;
        }
      });
  }
  ...
  Widget buildCategoryDropDown() {
    ...
    return DropdownButton(
      ...
      value: PacklistControllers.categoryController.text == ''
          ? _value
          : PacklistControllers.categoryController.text,
      onChanged: (String newValue) {
        setState(() {
          _value = newValue;
          PacklistControllers.categoryController.text = newValue;
        });
      },
      items: <String>[
        'Hike',
  ...
  initDropdown() {
    if (PacklistControllers.countryController.text != '') {
      ...
      currentRegions = countryRegions[PacklistControllers.countryController.text];
      changedRegion = true;
    }
  }

  Widget _buildCountryDropdown(UserProfile userProfile) {
    print('country ' + PacklistControllers.countryController.text);
    return DropdownButtonFormField(
      ...
      value: PacklistControllers.countryController.text == ''
          ? userProfile.country
          : PacklistControllers.countryController.text, // Intial value
      onChanged: (value) {
        setState(() {
          ...
          changedRegion = true;
          PacklistControllers.countryController.text = value;
        });
      },
  ...
  Widget _buildHikingRegionDropDown(UserProfile userProfile) {
    ...
    return DropdownButtonFormField(
      ...
      value: PacklistControllers.regionController.text == ''
          ? currentRegions.contains(userProfile.hikingRegion)
              ? userProfile.hikingRegion
              : null
          : currentRegions.contains(PacklistControllers.regionController.text)
              ? PacklistControllers.regionController.text
              : null, // Intial value
      onChanged: (value) {
        PacklistControllers.regionController.text = value;
      },
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> getMap() {
      return {
        'title': PacklistControllers.titleController.text,
        'createdBy': userProfile.id,
        'description': PacklistControllers.descriptionController.text,
        'category': PacklistControllers.categoryController.text,
        'country': PacklistControllers.countryController.text,
        'region': PacklistControllers.regionController.text,
        'price': PacklistControllers.priceController.text,
        'payment': PacklistControllers.paymentController.text,
        'maxParticipants': int.parse(PacklistControllers.maxParController.text),
        'minParticipants': int.parse(PacklistControllers.minParController.text),
        'participants': [],
        'requirements': PacklistControllers.requirementsController.text,
        'equipment': PacklistControllers.equipmentController.text,
        'meeting': PacklistControllers.meetingPointController.text,
        'dissolution': PacklistControllers.dissolutionPointController.text,
        'imageUrl': "nothing",
        'startDate': getDateTime2(
            PacklistControllers.startDateController.text, PacklistControllers.startTimeController.text),
        'endDate': getDateTime2(
            PacklistControllers.endDateController.text, PacklistControllers.endTimeController.text),
        'deadline': getDateTime(PacklistControllers.deadlineController.text),
      };
    }
    ...
    tryCreateEvent() async {
      ...
      if (value == 'Success') {
        ...
        PacklistControllers.updated = false;
      } else {
